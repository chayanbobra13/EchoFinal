package graycap.echo.databases
...
class EchoDatabase : SQLiteOpenHelper {
    ...
    fun storesAsFavorite(id: Int?, artist: String?, songTitle: String?, path: String?) {
        ...
        try {
            ...
            if (cSor.moveToFirst()) {
                do {
                    ...
                    var _title = cSor.getString(cSor.getColumnIndexOrThrow(Staticated.COLUMN_SONG_PATH))
